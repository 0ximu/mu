...
class IntentClassifier:
    ...
    _NOISE_WORDS = {
        ...
        "the", "a", "an", "to", "from", "in", "on", "at", "by", "for", "of", "with",
        # Code-related noise words that often follow identifiers
        "method", "methods", "function", "functions", "class", "classes",
        "module", "modules", "file", "files", "defined", "definition",
        "implementation", "implements", "interface", "type", "types",
        "variable", "variables", "constant", "constants", "attribute", "attributes",
        "property", "properties", "field", "fields", "here", "there",
    }
