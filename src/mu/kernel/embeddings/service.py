...
from mu.kernel.embeddings.providers.local import LocalEmbeddingProvider
from mu.kernel.embeddings.providers.openai import OpenAIEmbeddingProvider
...
class EmbeddingService:
    ...
    def _create_provider(self) -> EmbeddingProvider:
        ...
        if self._provider_type == EmbeddingProviderType.OPENAI:
            model = self._model
            if model is None and self._config:
